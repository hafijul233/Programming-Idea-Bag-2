...
namespace _01DistanceCalculatorApp
{
    public partial class DistanceCalculatorUi : Form
    {
        ...
        private void DistanceCalculatorUi_Load(object sender, EventArgs e)
        {
            //Input Fields Empty
        ...
        private void DistanceCalculatorUi_FormClosing(object sender, FormClosingEventArgs e)
        {
